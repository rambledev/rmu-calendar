// src/app/cio/change-password/page.tsx
"use client"

import { useState, useEffect } from "react"
import { useRouter } from "next/navigation"

export default function CioChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => router.push("/cio"), 2000)
      } else {
    ...
    <div className="admin-container">
      <header className="admin-header">
        <div className="admin-header-content">
          ...
          <button onClick={() => router.push("/cio")} className="back-to-dashboard">
            ← กลับสู่แดชบอร์ด
          </button>
        </div>
      </header>
          ...
          <div className="change-password-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-actions">
                <button type="button" onClick={() => router.push("/cio")} className="cancel-button">ยกเลิก</button>
